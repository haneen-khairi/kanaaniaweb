    ...
    <div class="row">
        <div class="col-12 col-xl-8">
            ...
            <div class="card card-body border-0 shadow mb-4">
                ...
                <form action="{{URL::to('/'.$lang.'/dashboard/sizes/store')}}" method="POST" id="product_form">
                    <div class="row">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 mb-3">
                            <button type="button" id="save_size" class="btn db-button" style="margin-top: 25px; margin-left:100px" >Save</button>
                        </div>
                    </div>
                </form>
