    ...
    <div class="row">
        <div class="col-12 col-xl-8">
            ...
            <div class="card card-body border-0 shadow mb-4">
                ...
                <form action="{{URL::to('/'.$lang.'/dashboard/categories/store')}}" method="POST" id="product_form">
                    <div class="row">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 mb-3">
                            <button type="button" class="btn db-button" style="margin-top:26px; margin-left:100px" id="save_category">Save</button>
                        </div>
                    </div>
                </form>
