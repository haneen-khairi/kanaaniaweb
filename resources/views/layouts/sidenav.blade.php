  ...
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item {{ Request::segment(2) == 'products' ? 'active' : '' }}">
        <a href="/en/dashboard/products" class="nav-link">
        ...
        <li class="nav-item {{ Request::segment(2) == 'categories' ? 'active' : '' }}">
            <a href="/en/dashboard/categories" class="nav-link">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                          xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
              <path fill-rule="evenodd"
        ...
        <li class="nav-item {{ Request::segment(2) == 'types' ? 'active' : '' }}">
            <a href="/en/dashboard/types" class="nav-link">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                          xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
              <path fill-rule="evenodd"
                ...
                <span class="sidebar-text">Types</span>
            </a>
        </li>

        <li class="nav-item {{ Request::segment(2) == 'sizes' ? 'active' : '' }}">
            <a href="/en/dashboard/sizes" class="nav-link">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                          xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
              <path fill-rule="evenodd"
        ...
        <li class="nav-item {{ Request::segment(2) == 'orders' ? 'active' : '' }}">
            <a href="/en/dashboard/orders" class="nav-link">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                          xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
              <path fill-rule="evenodd"
        ...
        <li class="nav-item {{ Request::segment(2) == 'subscribers' ? 'active' : '' }}">
            <a href="/en/dashboard/subscribers" class="nav-link">
          <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                                          xmlns="http://www.w3.org/2000/svg">
              <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z"></path>
              <path fill-rule="evenodd"
      ...
      <li class="nav-item">
        ...
        <div class="multi-level collapse" role="list" id="submenu-pages" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item">
              <a class="nav-link" href="/en/dashboard/home">
                <span class="sidebar-text">Sliders & Video</span>
              </a>
            </li>
              <li class="nav-item">
                  <a class="nav-link" href="/en/dashboard/home-types">
                      <span class="sidebar-text">Home Types</span>
                  </a>
              </li>
            <li class="nav-item">
              <a class="nav-link" href="/en/dashboard/testimonials">
                <span class="sidebar-text">Testimonials</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/en/dashboard/partners">
